            ...
            >
              {testimonials.map((slide, index) => (
                <SwiperSlide key={index} className="custom-testimonial-slide">
                  <div className="relative bg-cover bg-quinary bg-texture-background bg-blend-multiply bg-lightYellow py-10 px-6 rounded-3xl group w-full mx-auto max-w-[320px] sm:max-w-[350px] h-[372px] sm:h-[420px] 3xl:h-[430px] transition-all ease-in-out duration-500">
                    ...
                    <h4 className="transition-colors hover:text-tertiary">
                      <Text label={slide.title} size="xl" color="primary"/>
                    </h4>
                    <p className="transition-colors hover:text-tertiary">
