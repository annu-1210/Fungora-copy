...
const button = tv(
  {
    ...
    variants: {
      ...
      size: {
        ...
        lg: "w-[170px] h-[38px] sm:w-[175px] xl:w-[198px] sm:h-[46px] px-2.5 md:px-3 lg:px-4 py-1.5 sm:py-[11px] text-base xl:text-lg font-CooperExtrabold  xl:font-CooperBold z-50",
      },
    },
  },
  {
