...
const text = tv(
  {
    ...
    variants: {
      ...
      size: {
        ...
        xxl: "text-[38px] leading-[38px] sm:text-[40px] sm:leading-[42px] md:leading-[88.372%] md:text-[50px] xl:text-[70px] transition-all mx-auto md:mx-0 max-w-[620px] lg:max-w-[750px] xl:max-w-[900px] 3xl:max-w-[1070px] font-CooperBold sm:font-CooperBlack",
