...
const text = tv(
  {
    ...
    variants: {
      ...
      size: {
        xsm: "text-base lg:text-lg font-HelveticaNue !leading-[24px] pt-4 md:pt-6 lg:pt-[30px]",
        ...
        lg: "text-base md:text-lg lg:text-xl font-CooperBlack !leading-[24px] pt-8 md:pt-6 lg:pt-[30px]",
        xl: "text-xl xl:text-2xl font-CooperBlack max-w-[244px] !leading-[24px] pt-4 md:pt-6",
        xxl: "text-[38px] leading-[38px] sm:text-[40px] sm:leading-[88.872%] md:text-[50px] xl:text-[70px] transition-all mx-auto md:mx-0 max-w-[620px] lg:max-w-[750px] xl:max-w-[900px] 3xl:max-w-[1070px] font-CooperBold md:font-CooperBlack",
